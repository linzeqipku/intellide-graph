...
public class EmbeddingBasedHPFragment<NodeType, EdgeType> extends
	...
	@Override
	public void setEdgeRanking(int edgeIdx, double r) {this.subgraph.setEdgeRanking(edgeIdx, r);}
	@Override
	public double getEdgeRanking(int edgeIdx){return this.subgraph.getEdgeRanking(edgeIdx);}
