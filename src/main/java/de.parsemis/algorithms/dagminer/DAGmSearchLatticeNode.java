...
public class DAGmSearchLatticeNode<NodeType, EdgeType> extends
	...
	// added
	@Override
	public void setEdgeRanking(final int edgeIdx, double r) {fragment.setEdgeRanking(edgeIdx, r);}
	@Override
	public double getEdgeRanking(final int edgeIdx) {return fragment.getEdgeRanking(edgeIdx);}
	
	@Override
	public void setLastNumberOfEmbeddings(int size) {fragment.setLastNumberOfEmbeddings(size);}
	@Override
	public int getLastNumberOfEmbeddings() {return fragment.getLastNumberOfEmbeddings();}
	@Override
	public void addMaxRankedEdgeId(int id) {fragment.addMaxRankedEdgeId(id);}
	@Override
	public void setMaxRankedEdgeIds(ArrayList<Integer> ids) {fragment.setMaxRankedEdgeIds(ids);}
	@Override
	public ArrayList<Integer> getMaxRankedEdgeIds() {return fragment.getMaxRankedEdgeIds();}
	@Override
	public void setRanking(double ranking) {fragment.setRanking(ranking);}
	@Override
	public double getRanking() {return fragment.getRanking();}
	
	@Override
	public void setPruningMark(boolean flag) {fragment.setPruningMark(flag);}
	@Override
	public boolean getPruningMark() {return fragment.getPruningMark();}
