...
public class DAGmFragment<NodeType, EdgeType> extends
	...
	@Override
	public void setLastNumberOfEmbeddings(int number) {this.lastNumberOfEmbeddings = number;}
	@Override
	public int getLastNumberOfEmbeddings() {return this.lastNumberOfEmbeddings;}
	
	@Override
	public void setEdgeRanking(int edgeIdx, double r) {this.hpFragment.setEdgeRanking(edgeIdx, r);}
	@Override
	public double getEdgeRanking(int edgeIdx){return this.hpFragment.getEdgeRanking(edgeIdx);}
