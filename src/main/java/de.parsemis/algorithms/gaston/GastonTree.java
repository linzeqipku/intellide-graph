...
public class GastonTree<NodeType, EdgeType> extends
	...
	public void setEdgeRanking(final int edgeIdx, double r) {
		me.frag.setEdgeRanking(edgeIdx, r);
	}
	@Override
	public double getEdgeRanking(final int edgeIdx) {
		return me.frag.getEdgeRanking(edgeIdx);
	}
	@Override
	public void setLastNumberOfEmbeddings(int size) {me.frag.setLastNumberOfEmbeddings(size);}
	@Override
	public int getLastNumberOfEmbeddings() {return me.frag.getLastNumberOfEmbeddings();}
	@Override
	public void addMaxRankedEdgeId(int id) {me.frag.addMaxRankedEdgeId(id);}
	@Override
	public void setMaxRankedEdgeIds(ArrayList<Integer> ids) {me.frag.setMaxRankedEdgeIds(ids);}
	@Override
	public ArrayList<Integer> getMaxRankedEdgeIds() {return me.frag.getMaxRankedEdgeIds();}
	@Override
	public void setRanking(double ranking) {me.frag.setRanking(ranking);}
	@Override
	public double getRanking() {return me.frag.getRanking();}
	
	@Override
	public void setPruningMark(boolean flag) {me.frag.setPruningMark(flag);}
	@Override
	public boolean getPruningMark() {return me.frag.getPruningMark();}
