// $ANTLR 2.7.4: "Dot.g" -> "DotLexer.java"$
...
tryAgain:
	...
	public final void mWHITESPACE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
			{
				if ( _cnt13>=1 ) { break _loop13; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt13++;
		} while (true);
		...
		case '8':  case '9':
		{
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt29>=1 ) { break _loop29; } else {throw new NoViableAltForCharException(LA(1), getFilename(), getLine(), getColumn());}
				}
