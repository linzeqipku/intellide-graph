...
public interface HPFragment<NodeType, EdgeType> extends
	...
	// added
	public void setEdgeRanking(int edgeIdx, double r);
	public double getEdgeRanking(int edgeIdx);
	public void setLastNumberOfEmbeddings(int size);
	public int getLastNumberOfEmbeddings();
	public void addMaxRankedEdgeId(int id);
	public void setMaxRankedEdgeIds(ArrayList<Integer> ids);
	public ArrayList<Integer> getMaxRankedEdgeIds();
