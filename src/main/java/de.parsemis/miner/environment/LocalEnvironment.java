...
public class LocalEnvironment<NodeType, EdgeType> implements
	...
	private LocalEnvironment(final Settings<NodeType, EdgeType> settings,
		...
		//added
		this.nodeRanker = settings.nodeRanker;
		this.nodeRankerMinSize = settings.nodeRankerMinSize;
		this.nodeRankerLowerBound = settings.nodeRankerLowerBound;
		this.nodeRankerUpperBound = settings.nodeRankerUpperBound;
		this.nodeRankerSubsequentBugs = settings.nodeRankerSubsequentBugs;
		
		this.discriminativeFrequencies = settings.discriminativeFrequencies;
	}
